...
from field_rotation import make_plot
...
st.set_page_config(page_title='Field Rotation Calculator', layout='wide')
st.title('Alt-Az Telescope — Field Rotation Calculator')
...
basename = (f'fieldrotation_{tag}'
            ...
            f'_ha{int(ha_step)}_dec{int(dec_step)}')
...
# ---- legend ----
st.caption(
    '**Solid black** = constant declination  ·  '
    '**Dashed green** = constant hour angle (time grid)  ·  '
    'HA spacing shows how far a star moves in the given time interval'
)
